---
name: context-review
description: Use when review work needs compiled project context, source evidence, diagnostics, or task-focused context.
---
...
- Run `context task "$ARGUMENTS" --focus review` for focused task context.
