...
description: Use when testing work needs compiled project context, source evidence, diagnostics, or task-focused context.
---
...
- Run `context task "$ARGUMENTS" --focus testing` for focused task context.
