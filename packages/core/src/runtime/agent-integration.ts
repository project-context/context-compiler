...
function renderCodexExplorerAgent(): string {
  return [
    ...
    'After package drill-down, use list_package_correction_decisions, get_package_correction_decision, and replay_package_correction_decisions before list_package_corrections, get_correction_proposal, preview_correction_proposal, and low-level graph patch tools.',
...
function renderSkill(skill: ContextSkillDefinition): string {
  ...
  return [
    ...
    '- Use package correction decision memory tools (`list_package_correction_decisions`, `get_package_correction_decision`, `replay_package_correction_decisions`, `propose_package_correction_decision_revert`) before package correction proposal tools (`list_package_corrections`, `get_correction_proposal`, `preview_correction_proposal`, `approve_correction_proposal`, `reject_correction_proposal`, `apply_correction_proposal`) and low-level graph patch tools.',
