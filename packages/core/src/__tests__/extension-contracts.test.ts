...
import { defineContextExtension, validateContextExtensionManifest, type ContextExtensionManifest, type DocumentExtractorAdapterManifest } from '@context-compiler/core/extensions'
